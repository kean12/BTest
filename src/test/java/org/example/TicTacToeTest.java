...
public class TicTacToeTest {
	private static int[][] CENTER_X_BOARD = { { 0, 0, 0 }, { 0, TicTacToe.PLAYER_X, 0 }, { 0, 0, 0 }, };
	private static int[][] X_WINS_ROW_BOARD = { { 0, TicTacToe.PLAYER_O, TicTacToe.PLAYER_O },
			{ TicTacToe.PLAYER_X, TicTacToe.PLAYER_X, TicTacToe.PLAYER_X }, { TicTacToe.PLAYER_O, 0, 0 }, };
	private static int[][] DRAW_BOARD = { { TicTacToe.PLAYER_X, TicTacToe.PLAYER_O, TicTacToe.PLAYER_X },
	...
	/*
	 * @Test public void testPlaceMarkerX() { TicTacToe.placeMarker(emptyBoard, 2,
	 * 1, TicTacToe.PLAYER_X); assertEquals(0, emptyBoard[2][1]); assertEquals(0,
	 * emptyBoard[1][2]); }
	 * 
	 * @Test public void testPlaceMarkerO() { TicTacToe.placeMarker(emptyBoard, 2,
	 * 1, TicTacToe.PLAYER_O); assertEquals(0, emptyBoard[2][1]); assertEquals(0,
	 * emptyBoard[1][2]); }
	 * 
	 * 
	 * 
